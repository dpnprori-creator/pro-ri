...
-- === 38 PROVINCES ===
INSERT INTO provinces (code, name, capital, latitude, longitude) VALUES
  ('AC', 'Aceh', 'Banda Aceh', 4.6951, 96.7491),
  ('SU', 'Sumatera Utara', 'Medan', 3.5952, 98.6722),
  ('SB', 'Sumatera Barat', 'Padang', -0.9492, 100.3543),
  ('RI', 'Riau', 'Pekanbaru', 0.4733, 101.4482),
  ('KR', 'Kepulauan Riau', 'Tanjung Pinang', 0.8793, 104.4633),
  ('JA', 'Jambi', 'Jambi', -1.6101, 103.6131),
  ('SS', 'Sumatera Selatan', 'Palembang', -2.9761, 104.7755),
  ('BB', 'Bangka Belitung', 'Pangkal Pinang', -2.1342, 106.1172),
  ('BE', 'Bengkulu', 'Bengkulu', -3.8000, 102.2657),
  ('LA', 'Lampung', 'Bandar Lampung', -5.3971, 105.2663),
  ('JK', 'DKI Jakarta', 'Jakarta', -6.2088, 106.8456),
  ('JB', 'Jawa Barat', 'Bandung', -6.9175, 107.6191),
  ('BT', 'Banten', 'Serang', -6.1200, 106.1503),
  ('JT', 'Jawa Tengah', 'Semarang', -7.0051, 110.4381),
  ('DI', 'DI Yogyakarta', 'Yogyakarta', -7.7956, 110.3695),
  ('JI', 'Jawa Timur', 'Surabaya', -7.2575, 112.7521),
  ('BA', 'Bali', 'Denpasar', -8.6705, 115.2126),
  ('NB', 'Nusa Tenggara Barat', 'Mataram', -8.5833, 116.1167),
  ('NT', 'Nusa Tenggara Timur', 'Kupang', -10.1772, 123.6071),
  ('KB', 'Kalimantan Barat', 'Pontianak', -0.0232, 109.3423),
  ('KT', 'Kalimantan Tengah', 'Palangka Raya', -2.2105, 113.9188),
  ('KS', 'Kalimantan Selatan', 'Banjarmasin', -3.3186, 114.5944),
  ('KI', 'Kalimantan Timur', 'Samarinda', -0.5022, 117.1536),
  ('KU', 'Kalimantan Utara', 'Tanjung Selor', 2.8400, 117.3560),
  ('SA', 'Sulawesi Utara', 'Manado', 1.4748, 124.8421),
  ('SG', 'Sulawesi Tengah', 'Palu', -0.8983, 119.8600),
  ('SR', 'Sulawesi Selatan', 'Makassar', -5.1477, 119.4327),
  ('SE', 'Sulawesi Tenggara', 'Kendari', -3.9985, 122.5151),
  ('GO', 'Gorontalo', 'Gorontalo', 0.5330, 123.0685),
  ('SN', 'Sulawesi Barat', 'Mamuju', -2.6790, 118.8595),
  ('MA', 'Maluku', 'Ambon', -3.6554, 128.1908),
  ('MU', 'Maluku Utara', 'Sofifi', 0.7800, 127.6200),
  ('PA', 'Papua', 'Jayapura', -2.5330, 140.7182),
  ('PB', 'Papua Barat', 'Manokwari', -0.8667, 134.0833),
  ('PT', 'Papua Tengah', 'Nabire', -3.5400, 135.5000),
  ('PS', 'Papua Selatan', 'Merauke', -8.4600, 140.3300),
  ('PG', 'Papua Pegunungan', 'Wamena', -4.0900, 138.9500),
  ('PD', 'Papua Barat Daya', 'Sorong', -0.8700, 131.2500)
