...
export function CourseCertificatePDF({ data, showDownload = true }: { data: CourseCertificateData; showDownload?: boolean }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Visible preview — rendered client-side */}
...
export function CourseCertificatePrintView({ data }: { data: CourseCertificateData }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, textAlign: "center", width: "100%" }}>
        ...
        >
          {levelLabel[course.level] || course.level} · {course.total_lessons} pelajaran · {course.duration_hours} jam
        </p>
