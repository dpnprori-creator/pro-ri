...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Program unggulan PRO RI: Sekolah Robotika Rakyat, Robotika Masuk Sekolah, Akademi AI, Kompetisi Robotika Nasional, Inkubator Inovasi, Robotika UMKM.",
  },
};
